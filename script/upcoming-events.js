...
const sectiomUpcomingEvents = document.querySelector("#sectiomUpcomingEvents");
console.log(sectiomUpcomingEvents);
...
function crearCard(array) {
  sectiomUpcomingEvents.innerHTML = "";
  if (array.length === 0) {
    sectiomUpcomingEvents.innerHTML =
  ...
  array.forEach((element) => {
    ...
    sectiomUpcomingEvents.appendChild(card);
  });
}
